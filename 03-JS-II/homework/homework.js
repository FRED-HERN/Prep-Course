...
function saludo(idioma) {
  ...
  // Tu código:
  if(idioma.toLowerCase === "aleman") return "Guten Tag!";
  if(idioma.toLowerCase === "mandarin") return "Ni Hao!";
  if(idioma.toLowerCase === "ingles") return "Hello!";
  if(idioma.toLowerCase != "aleman" || "mandarin" || "ingles" || undefined);
    return "Hola!"
}
